...
pattern_en = [
    ...
    [r'(\.)([\d；：\. ]*(ISSN：).*)',  r'\1'],
    [r'(^(We thank|Special thanks?|References values|Department of|Arindam Sur|Robert Stenberg).*)', r''],
...
class clean_pattern:
    ...
    def delete_page_ending2(self, context):
        ...
        ending_starts = [
            [r'(^[\\ #]*(OPEN ACCESS)[\\ #]*$)'],
            # [r'(^[\\ #]*(Correspondence：|Citation：).{0,200})']
        ]
