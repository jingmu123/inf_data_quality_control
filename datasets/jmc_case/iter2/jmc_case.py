...
pattern_en = [
    ...
    [r'(^#*\s?([Ff]igs?(ure)?|F\s?IGS?(URE)?).*)', r'删除4:<u>\1</u>'],  # 删除开头为Figure的描述
...
fw = open(r"C:/Program Files/lk/projects/pdf/jmc_case/jmc_case_preformat_clean-test.jsonl", "w", encoding="utf-8")
