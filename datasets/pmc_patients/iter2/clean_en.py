...
pattern_en_list=[
    ...
    [r'(\n|^)((?:The|This) (?:case report|study) was (?:approved|conducted) (?:by|in).*)',r'\1删除2:<u>\2</u>'],
...
# fw = open(r"C:\Users\Administrator\PycharmProjects\untitled\pmc_patients\reclean1_pmc_patients.jsonl", "w", encoding="utf-8")
