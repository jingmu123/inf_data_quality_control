...
def process_item(item):
    ...
    wuguan = ["COMMENTARY_PCD_ s First", "“Antimicrobial Resistance of _", "\n_CDC Yellow Book:",
              ...
              "The author list was incorrect in the article", "The name of author Anne", "The article Hendra Virus"]
    for txt in wuguan:
        if txt in context:
