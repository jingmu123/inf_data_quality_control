...
fw = open(r"C:\pycharm\orc识别pdf清洗数据\pdf\clean_json\reclean0_differential_diagnosis_book.jsonl", "w", encoding="utf-8")
with open(r"C:\pycharm\orc识别pdf清洗数据\pdf\clean_json\original_data\differential_diagnosis_book_preformat.jsonl", "r", encoding="utf-8") as fs:
    lines = fs.readlines()
