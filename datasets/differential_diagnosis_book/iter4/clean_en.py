...
pattern_en = [
    ...
    [r'(^[\*_]*(www\.|E?mail:|[Hh]ttp|Copyright).*)', r'删除8:<u>\1</u>'],  # 网址、邮箱、Copyright
    ...
    [r'(^[\*_]*([Ff]rom：|Source：|Citation：).*)', r'删除13:<u>\1</u>'],  # 文献来源
...
fw = open(r"C:\Users\Administrator\Desktop\original_data\differential_diagnosis_book\differential_diagnosis_book_preformat_en_clean5.jsonl", "w", encoding="utf-8")
with open(r"C:\Users\Administrator\Desktop\original_data\differential_diagnosis_book\differential_diagnosis_book_preformat_en.jsonl", "r", encoding="utf-8") as fs:
    ...
    for items in tqdm(lines):
        ...
        seq_id = item["seq_id"]
        pattern = r'b2ab9a9f-1728-4436-8151-58cf3b3e9836$'
        ...
        # print(len(context))
        # for con in context[len(context)-500:]:
        #     print(con, '\n')
        item["text"] = context
