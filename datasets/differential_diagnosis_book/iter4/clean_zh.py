...
pattern_en_list=[
    ...
    [r'(\n|^)((?:# *第[0-9一-十四]+章.*参考文献\n*|参考文献(?:\n-+)?)+((?:\n+[*_]*\d+[.,，、\\]?.*)|(?:\n+.*\d{4}.*)|(?:\n+第[0-9一-十四]+[章节].*)|(?:\n+(少尿或无尿|多　尿|血 尿|血红蛋白尿|脓 尿|乳 糜 尿)))+)',r'\1删除3:<u>\2</u>(已删除)'],#改
    [R'(\n|^)((?:# *参考文献\n*|参[　 ]考[　 ]文[　 ]献(?:\n-+)?)+(?:\n+\d+[　 ].*\d{4}.*)+)',r'\1删除3:<u>\2</u>'],
    ...
    [r'(当遇到棘手的诊断问题时，表26-2所列的疾病一览表可资参考。)',r'删除8:<u>\1</u>'],
    ...
    [r'([。] *)(_[A-Za-z0-9]_)',r'\1删除12:<u>\2</u>'],#后缀字母，改
...
fw = open(r"C:\Users\Administrator\PycharmProjects\untitled\new\reclean4_differential_diagnosis_book_zh.jsonl", "w", encoding="utf-8")
