...
pattern_en = [
    ...
    [r'(^[\\\*_ ]*(\d+|[A-Z]{1,2}|SUGGESTED READING|Suggested Reading|ACKNOWLEDGMENTS?|Acknowledge?ments?|I. INTRODUCTION|[Rr][Ee][Ff][Ee][Rr][Ee][Nn][Cc] ?[Ee][Ss]?|(Selected )?References?|FURTHER READING|Further reading|5\'\-\-CACGTAAGCTATGCAGGCTT\-\-3\'|Useful websites)[\*_]*$)',  r'删除5:<u>\1</u>'],  # 参考文献标题及穿插的标题
    ...
    [r'(^[\*_]*(Also[,，]? [Ss]ee [Cc]hapter|For more details?[,，]|Acknowledgements are|We (also )?thank).*)', r'删除12:<u>\1</u>'],  # 一些特殊无关段
...
fw = open(r"C:\Users\Administrator\Desktop\original_data\differential_diagnosis_book\differential_diagnosis_book_preformat_en_clean3.jsonl", "w", encoding="utf-8")
with open(r"C:\Users\Administrator\Desktop\original_data\differential_diagnosis_book\differential_diagnosis_book_preformat_en.jsonl", "r", encoding="utf-8") as fs:
    ...
    for items in tqdm(lines):
        ...
        seq_id = item["seq_id"]
        pattern = r'd5577941-ae84-44fd-a89a-4b64c772ac54$'
