...
fw = open(r"C:\Users\Administrator\PycharmProjects\untitled\four mission\reclean0_high_quality-cde_manuals_fix_new.jsonl", "w", encoding="utf-8")
with open(r"C:\Users\Administrator\PycharmProjects\untitled\four mission\high_quality-cde_manuals_fix_new.jsonl", "r", encoding="utf-8") as fs:
# with open(r"C:\Users\Administrator\PycharmProjects\untitled\four mission\test.jsonl", "r", encoding="utf-8") as fs:
