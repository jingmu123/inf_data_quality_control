...
pattern_en = [
    ...
    [r'(^(Full?-text |Copyright|DOI：|(Name of |[\dl]? ?)?Department |Dr\. |organizations， or those of the publisher|New York Chiropractic and|Publisher[\'s ]*note：|Corresponding author：|Internal Medicine (.*)?Department|Conflict of interest|National Center of Cancer|[A-Z][a-z]+ of Medicine，|Heart Attack\.|start of Hajj in 2008).*)', r'删除2:<u>\1</u>'],
...
with open(r"C:/Program Files/lk/projects/pdf/acjr_mdpub_cases/acjr_mdpub_cases_preformat.jsonl", "r", encoding="utf-8") as fs:
    ...
    for items in tqdm(lines):
        ...
        if seq_id in wuguan_list:
            continue
        # if seq_id == "4f70f118-b2a4-4ab2-bc93-0f1f4f0d70aa":
