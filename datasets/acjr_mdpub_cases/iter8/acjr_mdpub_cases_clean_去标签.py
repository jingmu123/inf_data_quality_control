...
fw = open(r"C:/Program Files/lk/projects/pdf/acjr_mdpub_cases/acjr_mdpub_cases_preformat_clean8.jsonl", "w", encoding="utf-8")
with open(r"C:/Program Files/lk/projects/pdf/acjr_mdpub_cases/acjr_mdpub_cases_preformat.jsonl", "r", encoding="utf-8") as fs:
    ...
    for items in tqdm(lines):
        ...
        if seq_id in wuguan_list:
            continue
        # if seq_id == "4db09ac4-366a-4cd2-b809-21bc01d90052":
