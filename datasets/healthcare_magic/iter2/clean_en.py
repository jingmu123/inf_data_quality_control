...
pattern_en_list=[
    ...
    [r'(\(about like the 0 in this print\)|\(If the answer has helped you, please indicate this\)|\**Question\**: image attached *| *I hope you will find this useful Regards take care *|Wathch the video and read the pdf file.*|David Dzsizan@gmail.com *|RegardsBinu|Thank you for choosing HealthcareMagic\.|For a personalised comprehensive evaluation.*)',r'删除个例:<u>\1</u>'],
    [r'((?:\:\-?\()|(?:\:\-?\)))',r'删除符号:<u>\1</u>'],
    [r'([\.!\?])( *(?:Kind [Rr]egards|(?:[Tt]ake [Cc]are |[Ww]ith )?[Rr][Ee][Gg][Aa][Rr][Dd][Ss] *[\.!,]?(?: *[Dd][Rr])?|[Dd][Rr]|Best wishes|(?:Take Care\.)?Best|Yours truly|Truly yours|Hennie|Kim|(?:Many *)?Thanks!?(?: and [Rr]egards[\.,]?)?|Best of luck\.|[Tt]ake care[\.!]?|Thank you(?: *[Dd][Rr])?|Cheers & Godspeed!|X{3,}|(?:[Ww]ish(?:ing)?(?: you)?)? *(?:(?:good)? health|[Aa]ll the best|a nice weekend)!?(?: *[Dd][Rr])?|"?[Ww]ith.{1,20}wishes[",]?Dr|(?:[Oo][Kk])? *than(?:Q|l?k u)|Get well soon)(?:[ .&\-,]+[A-Z][^\n ]*)* *(?:\([^\(\)\n]+\))? ?)(\n|$)',r'\1删除1:<u>\2</u>\3'],
    # [r'([\.!\?])( *(?:(?:Many *)?Thanks!?(?: and [Rr]egards[\.,])?|Best of luck\.|(?: Wishing you )?[Aa]ll the best!?|[Tt]ake care[\.!]?|Thank you(?: *[Dd][Rr])?|Cheers & Godspeed!|X{3,}|Wishing *(?:good health|all the best|a nice weekend)|"With good health wishes"Dr|(?:[Oo][Kk])? *than(?:Q|l?k u))(?:[ .&\-,]+[A-Z][^\n ]*)* *(?:\([^\(\)\n]+\))? ?)(\n|$)',r'\1删除1:<u>\2</u>\3'],
    # [r'([\.!\?])( *(?:Kind [Rr]egards|(?:[Tt]ake [Cc]are )?[Rr][Ee][Gg][Aa][Rr][Dd][Ss] *[\.!,]?(?: *[Dd][Rr])?|[Dd][Rr]|Best wishes|(?:Take Care\.)?Best|Yours truly|Truly yours|Hennie|Kim)(?:[ .&\-,]+[A-Z][^\n ]*)* *(?:\([^\(\)\n]+\))? ?)(\n|$)',r'\1删除1:<u>\2</u>\3'],
...
fw = open(r"C:\Users\Administrator\PycharmProjects\untitled\healthcare_magic\reclean2_healthcare_magic.jsonl", "w", encoding="utf-8")
