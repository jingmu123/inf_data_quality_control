...
pattern_en_list=[
    ...
    [r'(\(about like the 0 in this print\)|\(If the answer has helped you, please indicate this\)|\**Question\**: image attached *| *I hope you will find this useful Regards take care *|Wathch the video and read the pdf file.*|David Dzsizan@gmail.com *|RegardsBinu)',r'删除个例:<u>\1</u>'],
    [r'((?:\:\-?\()|(?:\:\)))',r'删除符号:<u>\1</u>'],
    [r'([\.!\?])( *(?:Kind [Rr]egards|(?:Take care )?[Rr]egards[\.!]?|[Dd][Rr]|Best wishes|(?:Take Care\.)?Best|Yours truly,|Thanks(?: and regards.)?|Best of luck\.|(?: Wishing you )?[Aa]ll the best!?|Take care\.|Thank you|Cheers & Godspeed!)(?:[ ,.&]+[A-Z][^\n ]*)* ?)(\n|$)',r'\1删除1:<u>\2</u>\3'],
    # [r'([\.!\?])( *(?:With Best Wishes|Dr|Regards)(?:Dr)?(?:[ ,.&]+(?:[A-Za-z]|\([^\n\(\)]*\))[^\n ]*)+ ?http:\/+(?:www\/)?(?:[ \.]+W+)+.*)',r'\1删除7:<u>\2</u>'],

    [r'([\.!\?])([^\n.]*)((?:Https?[：:][/／]{2}(?:www[.．])?|www[.．])[a-zA-Z0-9@／/-]+(?:[.．／/][a-zA-Z0-9@／/_\-]{2,})+.*)',r'\1删除8:<u>\2\3</u>'],
...
fw = open(r"C:\Users\Administrator\PycharmProjects\untitled\healthcare_magic\reclean1_healthcare_magic.jsonl", "w", encoding="utf-8")
