...
pattern_en_list=[
    ...
    [r'(you can ask a direct question to me on this forum, following the below link.*)',r'删除2:<u>\1</u>'],
    ...
    [r'([,，] *(?:[Tt]ake care).{1,50})(\n|$)',r'. 删除5:<u>\1</u>\2'],
    [r'(\*\*Answer\*\*: Brief Answer: *(?:Thank you using|Please rate).*)',r'删除6:<u>\1</u>'],
    [r'([\.!\?,])( *(?:(?:With )?Best Wishes|Dr|Regards)(?:Dr)?.*(?:http:\/+)?(?:www\/)?(?:[ \.]+W+)+ *)(\n|$)', r'.删除7:<u>\1\2</u>\3'],
    [r'([A-Za-z])((?:[Rr][Ee][Gg][Aa][Rr][Dd][Ss]?).{0,30})(\n|$)',r'\1.删除9:<u>\2</u>\3'],

    [r'([:：])( *(?:(?:[A-Za-z\'][A-Za-z，,\'’\.\-]*|[&/]|[Aa][Nn][Dd]) +)+Response)',r'\1删除10:<u>\2</u>'],#改
...
# fw = open(r"C:\Users\Administrator\PycharmProjects\untitled\healthcare_magic\reclean4_healthcare_magic.jsonl", "w", encoding="utf-8")
