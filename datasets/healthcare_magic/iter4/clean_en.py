...
pattern_en_list=[
    [r'( *(?:[Hh][Ii](?: [A-Za-z0-9]{2,15})?[ \.!,]?|[Hh][Ee][Ll]{2}[Oo](?: [A-Za-z0-9]{2,15})?[ \.!,]?| ?and ?| ?[Dd][Ee][Aa][Rr] ?[A-Z][a-z]*\.[a-z]*[ \.!,]?| ?[Ww][Ee][Ll][Cc][Oo][Mm][Ee] ?| ?[Tt][Hh][Aa][Nn][Kk][Ss]? ?| ?[Ff][Oo][Rr] [Yy][Oo][Uu][Rr] [Qq][Uu][Ee][Rr][Yy] ?){2,}[^\n.?!]*(?:service|HCM|hcm|[Mm][Aa][Gg][Ii][Cc]|[Hh][Ee][Aa][Ll][Tt][Hh] ?[Cc][Aa][Rr][Ee]|site|[Ff][Oo][Rr][Uu][Mm])[\.?!]?)',r'删除11:<u>\1</u>'],#新
