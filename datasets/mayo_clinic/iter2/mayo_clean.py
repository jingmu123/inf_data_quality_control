...
class speicalProces:
    ...
    def step1_wuguantext_following(self, context):
        ...
        for index, item in enumerate(context):
            if re.search(
                    r'^(To read this article in full you will need to make a payment|Call your doctor for|Other side effects not listed may also occur in some|Supplemental Online Material|### Identification|### Footnotes|Article info|Acknowledgments?)',
...
fw = open(r"C:\pycharm\orc识别pdf清洗数据\pdf\clean_json\reclean2_mayo_clinic_preformat.jsonl", "w", encoding="utf-8")
