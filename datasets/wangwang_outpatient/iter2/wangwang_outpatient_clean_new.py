...
fw = open(r"C:/Program Files/lk/projects/pdf/wangwang_outpatient/wangwang_outpatient_preformat_clean-test.jsonl", "w", encoding="utf-8")
with open(r"C:/Program Files/lk/projects/pdf/wangwang_outpatient/wangwang_outpatient_preformat.jsonl", "r", encoding="utf-8") as fs:
    ...
    for items in tqdm(lines):
        ...
        title = item["title"]
        seq_id = item["seq_id"]
        # if seq_id == "4860dabd-d91f-42d2-bbbf-bbaf1eb22a85":
