...
pattern_en = [
    ...
    # ========================================================================================
    # 以下补充对此组数据清洗的特定正则
    [r'([\.,]\s)(\d{1,3}[\s–,\d{1,3}]{0,20})([A-Z]|$)',r'\1删除9：<u>\2</u>\3'],
    [r'([,]\s)(\d{1,3}[\s–,\d{1,3}]{0,20})([A-Za-z]|$)',r'\1删除13：<u>\2</u>\3'],

    [r'(\([^\n()]*(?:[Vv]ideos?|[Tt]able|F[iI][gG][sS]?(?:ures?|URES?)?|file) *\d+[^\n()]*\))',r'删除10：<u>\1</u>']
...
pattern_en_list=[
    ...
    [r'(?<=\n)((?:Ethics statements?\n+-*)(?:.*(?:\n|$)*)*)',r'删除5：<u>\1</u>'],
    [r'(?<=\n)((?:View this table:\n+)(?:\** *(?:View.*)\n*)+)',r'删除6：<u>\1</u>'],
    [r'(?:\n|^)(Request Permissions?\n+-*\n+If you wish to.*)',r'删除7：<u>\1</u>'],
    [r'(?:\n|^)(#* *Supplemental material\n+\\\[.*\\\])',r'删除8：<u>\1</u>'],
    [r'(?<=\n)(Video *\d+.*)',r'删除11：<u>\1</u>'],
    [r'(?<=\n)((?:\* *.*\n){2,})',r'删除12：<u>\1</u>']
