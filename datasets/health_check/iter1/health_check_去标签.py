...
pattern_zh_list=[
    [r'(?:\n)( *[\–\-\—] *谢谢合作 *祝您健康！ *)',r''],
    [r'(?:\n)(景德镇市中医医院健康管理中心温馨提示，本次体检报告只能体现您所检项目的内容。不是您全身整体状况的综合评估，您有其他不适或疑问可来我院进一步体检或电话咨询8510686。谢谢 *)',r'\n'],
    [r'(?:\n)( *北辰医院健康管理中心祝新老朋友身体安康，家庭幸福！\n *如您有不满及合理意见，请拨打体检中心科主任.*)',r'\n'],
    [r'([(（](?:https?:\/\/(?:www\.)?|www\.)?[A-Za-z0-9]+\.(?:com|cn|org)[）)])',r'']
]
...
fw = open(r"C:\Users\Administrator\PycharmProjects\untitled\health_check\reclean1B_health_check.jsonl", "w", encoding="utf-8")
with open(r"C:\Users\Administrator\PycharmProjects\untitled\health_check\health_check_preformat.jsonl", "r", encoding="utf-8") as fs:

# with open(r"C:\Users\Administrator\PycharmProjects\untitled\health_check\test.jsonl", "r", encoding="utf-8") as fs:
    lines = fs.readlines()
