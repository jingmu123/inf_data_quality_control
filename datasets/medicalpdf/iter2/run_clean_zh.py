from clean_zh import process_line
from clean_zh import speicalProces
...
if __name__ == '__main__':
    ...
    # save_file = f"{base_dir}/{file}_clean_zh.jsonl"
    # input_file = f"{base_dir}/{file}_preformat_zh.jsonl"
    save_file=r'C:\Users\Administrator\PycharmProjects\untitled\venv\test_done.jsonl'
    input_file=r'C:\Users\Administrator\PycharmProjects\untitled\venv\medicalpdf\medicalpdf_preformat_zh.jsonl'
    t1 = time.time()
