        ...
        with open(input_file, "r", encoding="utf-8") as file:
            ...
            for line in file:
                ...
                if current_line > end_line:
                    break
                try:
                    processed_chunk.append(process_line(line, ))
...
if __name__ == '__main__':
    ...
    total_lines = 9089
    cpu_num = 6
    lines_per_process = 500

    # base_dir = "../../../../full_data/{}".format(file)
    save_file = "C:/Program Files/lk/projects/pdf/medicalpdf/medicalpdf_preformat_en_6.jsonl"
    input_file = "C:/Program Files/lk/projects/pdf/medicalpdf/medicalpdf_preformat_en.jsonl"
    t1 = time.time()
