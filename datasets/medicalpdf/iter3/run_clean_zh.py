...
if __name__ == '__main__':
    ...
    save_file = "C:/Program Files/lk/projects/pdf/medicalpdf/medicalpdf_preformat_zh_clean_2.jsonl"
    input_file = "C:/Program Files/lk/projects/pdf/medicalpdf/medicalpdf_preformat_zh.jsonl"
    t1 = time.time()
