...
"reclean0B": [220,{'格式杂乱': 23, '无关文本': 109, '栏目混乱': 7, '导航栏': 1, '有用性': 55, '信息有用性': 17, '表格格式错误': 11, '信息完整性': 15, '语义不完整': 31, '信息不完整': 16, '错别字': 22, '缺少换行': 4, '多余换行': 8, '页眉': 1, '序号格式不一致': 2}],

}

if __name__ == "__main__":
    data_list = []
    dataset = medicalpdf_en_list
    data_count = 0
    ...
    compare_histograms(data_list,"medical_pdf_en 评估 采样(600)")
